  ...
  <div class="container">
      ...
      <el-table :data="contentList">
        ...
        <el-table-column label="操作" fixed="right">
          <template v-slot="scope">
            ...
            <el-button @click="handleDelete(scope.row)" v-permission="{ permission:'删除内容',type:'disabled'}">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
    ...
    >
      <el-form ref="form" :model="temp" label-width="90px" :rules="rules">
        <el-form-item lable="内容封面" prop="image">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="dialogTitle === '添加内容' ? confirmAdd() : confirmEdit()">保存</el-button>
      </span>
    </el-dialog>

    <el-dialog title="提示" :model-value="showDeleteDialog" width="400px">
      <span>确认删除内容？</span>
      <span slot="footer" class="dialog-footer">
